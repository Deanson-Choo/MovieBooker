...
export async function unlockSeat(showtimeId: number, seatId: number, sessionId: string) {
    ...
    let res: Response;
    try {
        res = await fetch(`${API_URL}/booking/showtimes/${showtimeId}/seats/${seatId}/unlock`, {
            method: 'POST',
            headers: {
